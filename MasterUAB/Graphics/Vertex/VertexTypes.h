...
#define CREATE_MVD3D11_VERTEX(StructName, HasPosition, HasPosition4, HasNormal, HasTangent, HasBinormal, HasWeightIndices, HasColor, HasUV, HasUV2) \
struct StructName \
{ \
	...
	//(StructName, HasPosition, HasPosition4, HasNormal, HasWeightIndices, HasColor, HasUV, HasUV2, HasBinormal, HasTangent)
...
CREATE_MVD3D11_VERTEX(MV_POSITION_NORMAL_TEXTURE_BINORMAL_TANGENT_VERTEX, 1, 0, 1, 1, 1, 0, 0, 1, 0); 
CREATE_MVD3D11_VERTEX(MV_POSITION_NORMAL_TEXTURE_TEXTURE2_BINORMAL_TANGENT_VERTEX, 1, 0, 1, 1, 1, 0, 0, 1, 1); 
CREATE_MVD3D11_VERTEX(MV_PARTICLE_VERTEX, 1, 0, 0, 0, 0, 0, 1, 1, 1);
//CREATE_MVD3D11_VERTEX(MV_POSITION_WEIGHT_INDICES_NORMAL_BINORMAL_TANGENT_TEXTURE_VERTEX, 1, 0, 1, 1, 1, 1, 0, 1, 0);
