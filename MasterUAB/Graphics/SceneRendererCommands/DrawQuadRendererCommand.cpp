...
{
	if(m_Material) { m_RenderableObjectTechnique=m_Material->GetRenderableObjectTechnique();	}
	else { m_RenderableObjectTechnique=CEngine::GetSingleton().GetRenderableObjectTechniqueManager()->GetResource("MV_POSITION4_COLOR_TEXTURE_VERTEX"); }
}  
