...
void CPhysXManagerImplementation::CreateCharacterController(const std::string &Name, float Height, float Radius, float Density, const Vect3f &Position, const std::string &MaterialName)
{
	CheckMapAndVectors();
