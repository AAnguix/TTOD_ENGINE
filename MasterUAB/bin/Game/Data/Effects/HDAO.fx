...
static float m_HDAOShowNormals=m_RawDataValues[1];
static float m_HDAOShowAO=m_RawDataValues[2];
static float m_HDAOUseNormals=m_RawDataValues[3];
...
// static float m_HDAOActive=1.0;
// static bool m_HDAOShowNormals=true;
// static bool m_HDAOShowAO=true;
// static bool m_HDAOUseNormals=true;
// static float2 m_RTSize=float2(800.0,600.0);
// static float m_AcceptAngle=0.98;
// static float m_HDAOIntensity=2.14;
// static float g_fQTimesZNearKK=m_RawDataValues[8];
// static float g_fQKK=m_RawDataValues[9];
// static float m_NormalScale=0.3;
// static float m_HDAORejectRadius=0.43;
// static float m_HDAOAcceptRadius=0.00312;
