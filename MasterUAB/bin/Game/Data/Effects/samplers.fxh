...
TextureCube T0CubeTexture : register( t0 );
TextureCube T1CubeTexture : register( t1 );
TextureCube T2CubeTexture : register( t2 );
TextureCube T3CubeTexture : register( t3 );
TextureCube T4CubeTexture : register( t4 );
TextureCube T5CubeTexture : register( t5 );
TextureCube T6CubeTexture : register( t6 );
