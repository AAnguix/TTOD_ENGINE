...
function CBasicEnemyComponent:Initialize()
	...
	local l_MoveToAttack = l_AnimatorController:AddState("MoveToAttack_State", "correr", 1.0, "OnEnter_MoveToAttack_BasicEnemy", "OnUpdate_MoveToAttack_BasicEnemy", "OnExit_MoveToAttack_BasicEnemy")
	local l_Attack = l_AnimatorController:AddState("Attack_State", "attack_idle", 1.0, "OnEnter_Attack_BasicEnemy", "OnUpdate_Attack_BasicEnemy", "OnExit_Attack_BasicEnemy")
	local l_Patrol = l_AnimatorController:AddState("Patrol_State", "correr", 1.0, "OnEnter_Patrol_BasicEnemy", "OnUpdate_Patrol_BasicEnemy", "OnExit_Patrol_BasicEnemy")
                                                   
	l_AnimatorController:AddBool("IsPlayerInsideVisionRange", true)
	l_AnimatorController:AddBool("DelayToPatrol", true)
	l_AnimatorController:AddBool("AtackPlayer", true)
...
function CBasicEnemyComponent:FollowPlayer(ElapsedTime)
	...
	local l_Cross = l_VectorToPlayer:cross(l_Forward)
